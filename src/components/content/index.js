      ...
      {tab === "Starships" &&
        swStarships.map((starships) => (
          <CharacterLayout key={starships.name} item={starships}>
            ...
            <CharacterList label="Cost in Credits: " item={starships.cost_in_credits} />
            <CharacterList label="Length: " item={starships.length} />
            <CharacterList label="Cargo Capacity: " item={starships.cargo_capacity} />
            <CharacterList label="Starship Class: " item={starships.starship_class} />
          </CharacterLayout>
        ))}
    </div>
  );
